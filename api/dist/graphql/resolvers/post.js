...
var _post = _interopRequireDefault(require("../../db/models/post"));
...
var _default = {
  ...
  mutation: {
    createPost: async (obj, args) => {
      ...
      const dbPost = new _post.default(post);
    ...
    deletePost: async (obj, args) => {
      ...
      const posts = _post.default.find({
        deletionDate: null
      });
